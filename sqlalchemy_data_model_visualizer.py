...
def generate_data_model_diagram(models, output_file='my_data_model_diagram', add_labels=True, view=True, models_to_exclude=None, file_format='svg'):
    ...
    dot = graphviz.Digraph(comment='Interactive Data Models', format=file_format,
